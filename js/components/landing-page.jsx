// populate tags in question <li>s
...
class LandingPage extends React.Component {
    ...
    joinRoom(id) {
        this.props.dispatch({type: "server/joinRoom", data: {questionID: id}});
    }
                                            ...
                                            <td className="inner-col">
                                                <div className="question-feed">
                                                    ...
                                                    <div className="filters">
                                                        ...
                                                        <button type="button" onClick={this.resetFilters}>Reset
                                                            Filters
                                                        </button>
                                                        <TagsSearchBar text="Filter questions by tags"
                                                                       onInput={this.filtersSearch}
                                                                       output={this.props.filtersOutput} what="filter"/>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
